...
//    protected void placePicker() {
//
//        ((BaseActivity) getActivity()).getPlacePickerFromGoogleMaps();
//    }

//    public CommunicationIntentService getCommunicationIntentService() {
//        return communicationIntentService;
//    }

//    protected void inviteWithFirebase(String inviteFrom) {
//        Intent intent = new AppInviteInvitation.IntentBuilder(getString(R.string.share_with_friend))
//                .setMessage(getString(R.string.firebase_invite_message, inviteFrom))
//                .setOtherPlatformsTargetApplication(AppInviteInvitation.IntentBuilder.PlatformMode.PROJECT_PLATFORM_IOS, BuildConfig.APPLICATION_ID)
//                .build();
//        startActivityForResult(intent, AppConstants.FIREBASE_REQUEST_INVITE);
//    }
...
//    public void startActivity(Class<? extends Activity> clazz, String id) {
//        Intent intent = new Intent(getContext(), clazz);
//        intent.putExtra(AppConstants.OBJECT_ID, id);
//        startActivity(intent);
//    }
//
//
//    public String createFromInviteName() {
//        String inviteName = "ChallengeNow";
//        if (getSession().getTeam().getName() != null)
//            inviteName = getSession().getTeam().getName();
//
//        return inviteName;
//    }
...
//        startActivity(communicationIntentService.sendEmail(mailTo, subject));
//    }
//
//    public void makeCall(String phoneNumber) {
//        startActivity(communicationIntentService.createCall(phoneNumber));
//    }
//
//    public void shareLink(String url) {
//        startActivity(Intent.createChooser(communicationIntentService.shareLink(url), "Share link using"));
//    }
