...
public class FoodRequestListAdapter extends ArrayAdapter<RequestListModel> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (rowItem != null) {
            ...
            if (convertView == null) {
                convertView = mInflater.inflate(R.layout.tournament_item,
                        null);
                holder = new FoodRequestListAdapter.ViewHolder();
                holder.tournamentName = convertView.findViewById(R.id.tournamentName);
            ...
            holder.tournamentName.setTag(rowItem.getId());
            holder.tournamentName.setText(rowItem.getTitle());
...
//            holder.spots.setText(rowItem.getMaxParticipants() + " " + getContext().getResources().getString(R.string.spots));
            ...
            final int spotsLeft = rowItem.getPersonLimit();
            if (spotsLeft > 1) {
                ...
                holder.spots.setText(getContext().getResources().getString(R.string.tournament_full));
