...
public class FoodRequestParticipantListAdapter extends ArrayAdapter<User> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        FoodRequestParticipantListAdapter.ViewHolder holder = null;
        User rowItem = getItem(position);
        if (rowItem != null) {
            LayoutInflater mInflater = (LayoutInflater) context
                    .getSystemService(Activity.LAYOUT_INFLATER_SERVICE);
            if (convertView == null) {
                convertView = mInflater.inflate(R.layout.tournament_participant_item,
                        null);
                holder = new FoodRequestParticipantListAdapter.ViewHolder();
                ...
                holder = (FoodRequestParticipantListAdapter.ViewHolder) convertView.getTag();
